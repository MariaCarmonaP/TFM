...
def split_data(folder_in, folder_out, train_pct):
    ...
    files = [f for f in os.listdir(folder_in) if f.endswith(".png")]
    ...
    for f in train_files:
        ...
        label_file = os.path.join(folder_in, f.replace(".png", ".txt"))
...
folder_in = "./Img&Label_ocr"
folder_out = "./datasets/OCR_Dataset/DATASET_06_03_24"
train_pct = 90
